...
### 问题描述
&emsp;&emsp;对于给定的超定线性方程组$Ax = b$，直接通过矩阵求解是困难的。这里就用到了逼近的思想。假设上述方程存在一个噪声$e$，则可以写成$b-Ax = e$，接下来要做的就是求解出能够极小化这个噪声的$x$。本题要求使用到了递推最小二乘法。
### 算法设计
...
![快速傅里叶变换测试结果](https://raw.githubusercontent.com/leungyukshing/Numerical-Computation-Methods/master/%E6%95%B0%E5%80%BC%E8%AE%A1%E7%AE%97%E7%AC%AC%E4%BA%8C%E6%AC%A1%E5%AE%9E%E9%AA%8C/Images/%E5%BF%AB%E9%80%9F%E5%82%85%E9%87%8C%E5%8F%B6%E5%8F%98%E6%8D%A2.png)
**分析**：左边的图是经过自己写的FFT算法得出的系数，右边的图是使用matlab自带的FFT方法求出的系数，对比两幅图基本一致，可以基本判断FFT算法实现正确。
